...
local function finder(Query, ForceSearch, CustomCallLimit, PrintResults)
    ...
    -- Lưu kết quả vào file sau khi quét xong
    local HttpService = game:GetService("HttpService")
    local jsonData = HttpService:JSONEncode(globalcontainer)  -- Chuyển đổi bảng thành JSON
    writefile("globalcontainer_data.json", jsonData)  -- Lưu vào file
